...
const ensureSchema = async () => {
  ...
  const createTableQueries = [
    ...
    // ParameterMaster table
    `CREATE TABLE IF NOT EXISTS ParameterMaster (
      Id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ...
    // ProductInspections table
    `CREATE TABLE IF NOT EXISTS ProductInspections (
      Id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ...
    // IncomingMaterialInspections table
    `CREATE TABLE IF NOT EXISTS IncomingMaterialInspections (
      Id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ...
    // ProductInspectionPlans table
    `CREATE TABLE IF NOT EXISTS ProductInspectionPlans (
      Id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
      ItemId NVARCHAR(100) NOT NULL,
      ItemDescription NVARCHAR(255) NOT NULL,
    ...
    // IncomingMaterialInspectionPlans table
    `CREATE TABLE IF NOT EXISTS IncomingMaterialInspectionPlans (
      Id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
      ItemId NVARCHAR(100) NOT NULL,
      ItemDescription NVARCHAR(255) NOT NULL,
      DocNumber NVARCHAR(50),
  ...
  const createIndexQueries = [
    `CREATE INDEX IF NOT EXISTS IX_ParameterMaster_CreatedAt ON ParameterMaster (CreatedAt DESC)`,
    `CREATE INDEX IF NOT EXISTS IX_ProductInspections_CreatedAt ON ProductInspections (CreatedAt DESC)`,
    `CREATE INDEX IF NOT EXISTS IX_IncomingMaterialInspections_CreatedAt ON IncomingMaterialInspections (CreatedAt DESC)`,
    `CREATE INDEX IF NOT EXISTS IX_ProductInspectionPlans_CreatedAt ON ProductInspectionPlans (CreatedAt DESC)`,
    `CREATE INDEX IF NOT EXISTS IX_IncomingMaterialInspectionPlans_CreatedAt ON IncomingMaterialInspectionPlans (CreatedAt DESC)`
  ];
